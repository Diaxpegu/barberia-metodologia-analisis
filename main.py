...
# ==========================================
# CONFIGURACIÓN APP (RADIANT)
# ==========================================
app = FastAPI(title="API Barbería Radiant", version="3.0.0")

# CORS ACTUALIZADO
origins = [
    "http://localhost:3000",
    "https://web-production-23c06.up.railway.app", # Tu Frontend en Railway
    "*" # Permitir todo (opcional, útil para pruebas)
]
...
@app.get("/")
def root():
    return {"mensaje": "API Barbería Radiant Activa"}
